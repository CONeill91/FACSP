package javaCC;/* CasperParser.java */
...
tmp.append(t.image); values.add(tmp.toString());
  ...
  static final public Message msg() throws ParseException {Token t; Message m; MessageList messagelist;
...
if(messagelist.getMessageList().size() == 1){
  ...
  static final public Message cpt() throws ParseException {Token tok = null; Message m = null; Message t;
    if (jj_2_3(2)) {
...
if(tok == null){
  ...
  static final public Message term() throws ParseException {Token t = null; Message atomMessage; Message termMessage = null;
    atomMessage = msgAtom();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case XOR:{
...
if(t == null){
  ...
  static final public Message msgAtom() throws ParseException {Token t; Token t1 = null; Token t2 = null;  Message m = null; Message k;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ID:{
      t = jj_consume_token(ID);
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return t;}
  ...
  static final public Protocol script() throws ParseException {Protocol p = new Protocol(); Intruder i;
    free_vars();
    processes();
    prot_desc();
    spec_section();
...
p.setIntruder(i); {if ("" != null) return p;}
  ...
  static final public void prot_msg() throws ParseException {Token t; Token l; Message m;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LESS_THAN:{
      assignment_line();
      break;
...
System.out.println(l.image + " " + m);
  ...
  static final public void env_msg_send() throws ParseException {Token t; Message m;
...
System.out.println(m);
  ...
  static final public void env_msg_rec() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LESS_THAN:{
      assignment_line();
      break;
