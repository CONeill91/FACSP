...
atomValues.add(t.image);    {if ("" != null) return atomValues;}
  ...
  final public void fn_app(ArrayList<String> values) throws ParseException {Token t;StringBuilder tmp = new StringBuilder();
    t = jj_consume_token(ID);
tmp.append(t.image);
...
{if ("" != null) return m;}
  ...
  final public void spec() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SECRET:{
...
// TODO Change to N
  ...
  final public Intruder intruder() throws ParseException {Token t; Token t1;
